...
- [Knowledge graph in education](knowledge-graph-in-education.md): the public
  education report for parents, educators, tutors, and students using a
...
- [EaseFactor product roadmap](easefactor-product-roadmap.md): the product
  roadmap and canonical source for capability status, ownership, and product
  sequencing.
- [EaseFactor taxonomy integration spec](easefactor-taxonomy-integration-spec.md):
  the technical architecture for product philosophy, API shape, and stable
  integration prerequisites.
- [EaseFactor reference slice](easefactor-reference-slice.md): dependency-free
  runnable reference for a Class 6 Mathematics Number System integration
  example and service mapping.
